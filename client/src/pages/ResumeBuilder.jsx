...
const ResumeBuilder = () => {
    ...
    const saveResume = async () => {
        try {
            ...
            // delete image from updatedResumeData
            ...
            // check if user wants to remove background
            removeBackground && formData.append('removeBackground', 'yes');
            //  if get image in resumeData add it to dataFormat
        ...
        <div>
            <div className='max-w-7xl mx-auto px-4 py-6'>
                <Link to={'/app'} className='inline-flex gap-2 items-center text-slate-500 hover:text-slate-700 transition-all'>
                    <ArrowLeftIcon className='size-4' /> Back toDashbord
                </Link>
            </div>
                ...
                <div className='grid lg:grid-cols-12 gap-8'>
                    ...
                    <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
                        <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
                            ...
                            {/* sections navigation */}
                            <div className='flex justify-between items-center mb-6 border-b border-greey-300 py-1'>
                                ...
                                <div className='flex items-center'>
                                    ...
                                    {activeSectionIndex !== sections.length - 1 && (
                                        <button className='flex items-center gap-1 p-3 rounded-lg text-sm font-medium
                                        text-gray-600 hover:bg-gray-50 transition-all' disabled={activeSectionIndex === sections.length - 1}
                            ...
                            <div className='space-y-6'>
                                {activeSection.id === "personal" && (
                                    <PersonalInfoForm data={resumeData.personal_info}
                                        ...
                                        removeBackgraund={removeBackground} setRemoveBackgraund={setRemoveBackground} />
                                )}
                            ...
                            text-green-600 ring hover:ring-green-400 transition-all rounded-md px-6 py-2 mt-6 text-sm'
                                onClick={() => { toast.promise(saveResume(), { loading: 'Saving resume...' }) }}>
                                Save Changes
                            </button>
                        </div>
                    </div>
