...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
    ...
    const templates = [
        ...
        },
        {
            id: "modern",
            name: "Modern",
            preview: "A modern and minimalistic resume design with a focus on clean typography and minimalistic elements.",
        },
        {
            id: "minimal",
            name: "Minimal",
            preview: "A minimalistic resume format with a focus on clean typography and minimalistic elements.",
        },
        {
            id: "minimal-image",
