...
const Testimonial = () => {
    ...
    return (
        <>
            <div id='testimonials' className='flex flex-col items-center my-10 scale-mt-12'>
                <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-6 py-1.5">
                    <BookUserIcon className='size-4.5 stroke-green-600' />
                    <span>Testimonials</span>
                </div>

                <Title title="Don't just take our word" description="Hear what our user say about us. We're always looking
                for ways to improve. If you have positive experience with us, leava a review."/>
            </div>
