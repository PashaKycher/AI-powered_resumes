...
const Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scale-mt-12'>
            ...
            <Title title='Bild your resume' description='Our streamliner process helps you create a professional resume in minutes
